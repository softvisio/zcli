...
export class LintFile {
    ...
    constructor ( file, { type, cwd, processUnsupportedTypes, write, eslintCode = true, eslintExperimental, fix = true, log = true, cache } = {} ) {
        ...
        this.#cache = cache || {};
        this.#eslintCode = Boolean( eslintCode );
